...
// DO NOT MODIFY
// GENERATED ON: 2021-03-29 14:17:11.063080
...
{
  return HmacSha256SetKey (HmacSha256Context, Key, KeySize);
}
/**
...
{
  return Pkcs5HashPassword (PasswordLength, Password, SaltLength, Salt, IterationCount, DigestSize, KeyLength, OutKey);
}
/**
...
{
  return Pkcs1v2Encrypt (PublicKey, PublicKeySize, InData, InDataSize, PrngSeed, PrngSeedSize, EncryptedData, EncryptedDataSize);
}
/**
...
{
  return Pkcs7GetSigners (P7Data, P7Length, CertStack, StackLength, TrustedCert, CertLength);
}
/**
...
{
  return Pkcs7GetCertificatesList (P7Data, P7Length, SignerChainCerts, ChainLength, UnchainCerts, UnchainLength);
}
/**
...
{
  return Pkcs7Sign (PrivateKey, PrivateKeySize, KeyPassword, InData, InDataSize, SignCert, OtherCerts, SignedData, SignedDataSize);
}
/**
...
{
  return VerifyEKUsInPkcs7Signature (Pkcs7Signature, SignatureSize, RequiredEKUs, RequiredEKUsSize, RequireAllPresent);
}
/**
...
{
  return X509GetOrganizationName (Cert, CertSize, NameBuffer, NameBufferSize);
}
/**
...
{
  return X509ConstructCertificateStackV (X509Stack, Args);
}
/**
  Construct a X509 stack object from a list of DER-encoded certificate data.
  If X509Stack is NULL, then return FALSE.
  ...
  )
{
  ...
  Result = CryptoServiceX509ConstructCertificateStack (X509Stack, Args);
  VA_END (Args);
  return Result;
}
/**
...
{
  return Sm3Duplicate (Sm3Context, NewSm3Context);
}
/**
...
{
  return Sm3Update (Sm3Context, Data, DataSize);
}
/**
...
{
  return Sm3Final (Sm3Context, HashValue);
}
/**
...
{
  return Sm3HashAll (Data, DataSize, HashValue);
}
//=============================================================================
//     HKDF functions
//=============================================================================
...
{
  return HkdfSha256ExtractAndExpand (Key, KeySize, Salt, SaltSize, Info, InfoSize, Out, OutSize);
}
//=============================================================================
//     TLS functions
//=============================================================================
...
{
  return TlsCtxNew (MajorVer, MinorVer);
}
/**
...
{
  return TlsDoHandshake (Tls, BufferIn, BufferInSize, BufferOut, BufferOutSize);
}
/**
...
{
  return TlsHandleAlert (Tls, BufferIn, BufferInSize, BufferOut, BufferOutSize);
}
/**
...
{
  return TlsCloseNotify (Tls, Buffer, BufferSize);
}
/**
...
{
  return TlsCtrlTrafficOut (Tls, Buffer, BufferSize);
}
/**
...
{
  return TlsCtrlTrafficIn (Tls, Buffer, BufferSize);
}
/**
...
{
  return TlsRead (Tls, Buffer, BufferSize);
}
/**
...
{
  return TlsWrite (Tls, Buffer, BufferSize);
}
//=============================================================================
//     TLSSET functions
//=============================================================================
...
{
  return TlsSetVersion (Tls, MajorVer, MinorVer);
}
/**
...
{
  return TlsSetConnectionEnd (Tls, IsServer);
}
/**
...
{
  return TlsSetCipherList (Tls, CipherId, CipherNum);
}
/**
...
{
  return TlsSetCompressionMethod (CompMethod);
}
/**
...
{
  return TlsSetVerifyHost (Tls, Flags, HostName);
}
/**
...
{
  return TlsSetSessionId (Tls, SessionId, SessionIdLen);
}
/**
...
{
  return TlsSetCaCertificate (Tls, Data, DataSize);
}
/**
...
{
  return TlsSetHostPublicCert (Tls, Data, DataSize);
}
/**
...
{
  return TlsSetHostPrivateKey (Tls, Data, DataSize);
}
/**
...
{
  return TlsSetCertRevocationList (Data, DataSize);
}
//=============================================================================
//     TLSGET functions
//=============================================================================
...
{
  return TlsGetConnectionEnd (Tls);
}
/**
...
{
  return TlsGetCurrentCipher (Tls, CipherId);
}
/**
...
{
  return TlsGetCurrentCompressionId (Tls, CompressionId);
}
/**
...
{
  return TlsGetSessionId (Tls, SessionId, SessionIdLen);
}
/**
...
{
  return TlsGetKeyMaterial (Tls, KeyMaterial);
}
/**
...
{
  return TlsGetCaCertificate (Tls, Data, DataSize);
}
/**
...
{
  return TlsGetHostPublicCert (Tls, Data, DataSize);
}
/**
...
{
  return TlsGetHostPrivateKey (Tls, Data, DataSize);
}
/**
...
{
  return TlsGetCertRevocationList (Data, DataSize);
}
